---
title: 'Refund Policy'
description: 'Refund Policy for SanoServers.'
icon: "book-bookmark"
---
...
|--------------------|----------|-------------------------|
| VPS                | Any      | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Website Hosting    | Any      | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Game Hosting       | Any      | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Dedicated Servers  | Any      | <span style={{color: "#FF6366"}}>Does Not qualify</span>        |
| Micro KVM          | Any      | <span style={{color: "#FF6366"}}>Does Not Qualify</span>        |
| LXC Containers     | Any      | <span style={{color: "#FF6366"}}>Does Not Qualify</span>        |
...
|--------------------|------------------------------------|-------------------------|
| PayPal             | Legacy and Billing Agreements qualify | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Stripe             | Includes Alipay, Google Pay, ApplePay, etc. | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Account Credit     | Only refunded back to account credit | <span style={{color: "#00DF71"}}>Qualifies for refunds</span>   |
| Cryptocurrency     |                                    | <span style={{color: "#FF6366"}}>Does Not Qualify</span>        |
| Bank Transfer      |                                    | <span style={{color: "#FF6366"}}>Does Not Qualify</span>        |
